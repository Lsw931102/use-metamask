...
const useMetamask = () => {
	...
	const connect = async (Web3Interface, settings = {}) => {
		...
		if (!Web3Interface) throw Error('Web3 Provider is required. You can use either ethers.js or web3.js')
		...
		const _web3 = new Web3Interface(...(Object.keys(settings).length ? [provider, settings] : [provider]))
